...
<body>
    <ul class="nav nav-pills">
          ...
          <!-- -->
           <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?PHP echo"?PG_SA=DA_BRG_01&PG_SA_SUB=DA_BRG_01_KAT_IN"; ?>">ENTR!</a>
              <a class="dropdown-item" href="<?PHP echo"?PG_SA=DA_KODE_01&PG_SA_SUB=DA_KODE_01_IN_VIEW"; ?>">Manage Kategori</a>
    ...
    <hr>
    	 <div style="overflow:auto;width:auto;height:600px;padding:2px; padding-left:9px; border:1px solid #eee">
