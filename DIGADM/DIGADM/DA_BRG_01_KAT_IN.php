...
<?PHP if($da_vus01_sww['user_akses_01']=="A1"){ ?>
		<form method="post">
          ...
          <div class="card-header">#Entri Kategori Barang</div>
          <div class="card-body">
          <!-- -->
            ...
            <b>#Reff ID</b>
            <input type="text" name="da_kat_kode_01" readonly class="form-control form-control-sm" required value="<?PHP echo"$da_cq_vkbrg01_sw"; ?>">
            <br>
            
             <b>#Kategori</b>
            <input type="text" name="da_kat_nama_01"  class="form-control form-control-sm" required autocomplete="off">
            
            <br>
                <button class="btn btn-success btn-sm" name="da_kat_simpan_01"><i class="fas fa-check"></i>&nbsp;Simpan Data</button>
          <!-- -->
          </div>
          </div>
